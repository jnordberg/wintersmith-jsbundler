...
(function (global) {
  ...
  require.define('/main.coffee', function (module, exports, __dirname, __filename) {
    var foo, log, main, periodic;
    foo = require('/foo.js', module);
    log = require('/log.coffee', module);
    periodic = require('/subdir/periodic.js', module);
    main = function () {
      log('I can have green tea?');
      foo('tea');
      return periodic('hello there', log);
    };
